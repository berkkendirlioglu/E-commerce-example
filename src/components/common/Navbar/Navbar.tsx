          ...
          <div className={`${styles["search-account-basket"]}`}>
            <div className={`${styles["search-wrapper"]}`}>
              <input
                ...
                type="text"
              />
              <label className={`${styles["search-button"]}`} htmlFor="Search">
                ARA
              </label>
            </div>
            ...
            <div className={`${styles["basket-wrapper"]}`}>
              ...
              >
                <i className={`${styles["basket-icon"]} bi bi-cart3 `}>
                  <p className={`${styles["product-count"]}`}>{basket.length}</p>
                </i>
            ...
            >
                ...
                {basket.length > 0 ? (
                  ...
                  <div className={`${styles["product-box"]}`}>
                    ...
                    <div className={`${styles["product-count-price"]}`}>
                      <div className={`${styles["product-price"]}`}>{product.price.total_price * product.count!}&nbsp;TL</div>
              ...
              <div className={`${styles["basket-total-price"]}`}>
                <span className={`${styles["total-price"]}`}>TOPLAM {basketTotalPrice} TL</span>
              </div>
